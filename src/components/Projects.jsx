        ...
        <div>
            ...
            <div className='bg-red-50 font-display'>
                ...
                <div className='grid grid-cols-1 rows-2 gap-8 lg:grid-cols-2 lg:gap-0'>
                    <div className='align-items-center flex justify-center'>
                        <div className="max-w-md rounded-2xl bg-white overflow-hidden shadow-lg sm:justify-end">
                            <img className="w-full" src="/images/StudyWatch.png" alt="Study Watch" />
                            ...
                            <div className="px-6 pt-4 pb-2">
                                <span className="inline-block bg-red-700 text-white rounded-2xl px-3 py-1 text-sm font-semibold mr-2 mb-2">
                    ...
                    <div className='align-items-center flex justify-center'>
                        <div className="max-w-md rounded-2xl bg-white overflow-hidden shadow-lg">
                            <img className="w-full" src="/images/OrbikDesign.png" alt="ORBIK Website" />
                            <div className="px-6 py-4">
                ...
                <div className='grid grid-cols-1 rows-2 gap-8 lg:grid-cols-2 lg:gap-0'>
                    <div className='align-items-center flex justify-center'>
                        <div className="max-w-md rounded-2xl bg-white overflow-hidden shadow-lg sm:justify-end">
                            <img className="w-full" src="/images/PowerBI.png" alt="HHRR Summary" />
                            <div className="px-6 py-4">
                            ...
                            <button class="px-6 pt-4 pb-2">
                                <a href="https://drive.google.com/file/d/17UB4OwK_iWhmYe4e3KBTXF2tru5AwzQ0/view?usp=drive_link" class="inline-block bg-red-700 text-white rounded-2xl px-3 py-1 text-sm font-semibold mr-2 mb-2">See Project</a>
                            </button>
                        </div>
                    </div>
                    <div className='align-items-center flex justify-center'>
                        <div className="max-w-md rounded-2xl bg-white overflow-hidden shadow-lg">
                            <img className="w-full" src="/images/QlikSense.png" alt="Sales Sumary" />
                            <div className="px-6 py-4">
                            ...
                            <div className="px-6 pt-4 pb-2">
                                <a href='https://drive.google.com/file/d/1zUEgpfKkDTSf3SnJwwrwHFxL8DPGkqvZ/view?usp=drive_link' className="inline-block bg-red-700 text-white rounded-2xl px-3 py-1 text-sm font-semibold  mr-2 mb-2">See Project</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='grid grid-cols-1 rows-2 gap-8 lg:grid-cols-2 lg:gap-0 pb-25'>
                    <div className='align-items-center flex justify-center'>
                        <div className="max-w-md rounded-2xl bg-white overflow-hidden shadow-lg sm:justify-end">
                            <img className="w-full" src="/images/GymReact.png" alt="Gym Website" />
                            <div className="px-6 py-4">
                            ...
                            <button class="px-6 pt-4 pb-2">
                                <span class="inline-block bg-red-700 text-white rounded-2xl px-3 py-1 text-sm font-semibold mr-2 mb-2">See Project</span>
                            </button>
                        </div>
                    </div>
                    <div className='align-items-center flex justify-center'>
                        <div className="max-w-md rounded-2xl bg-white overflow-hidden shadow-lg">
                            <img className="w-full" src="/images/Agropecuando.png" alt="Agricultural and livestock blog" />
                            <div className="px-6 py-4">
                            ...
                            <div className="px-6 pt-4 pb-2">
                                <span className="inline-block bg-red-700 text-white rounded-2xl px-3 py-1 text-sm font-semibold  mr-2 mb-2">See Project</span>
                            </div>
                        </div>
                    </div>
                </div>
